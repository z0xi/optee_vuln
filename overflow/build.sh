...
HOST_CROSS_COMPILE=a/home/hei/Desktop/optee-qemu/toolchains/aarch64/bin/aarch64-linux-gnu-
# Build the host application
cd $CURDIR/host
make CROSS_COMPILE=$HOST_CROSS_COMPILE $@

# Toolchain prefix for the Trusted Applications
TA_CROSS_COMPILE=/home/hei/Desktop/optee-qemu/toolchains/aarch64/bin/aarch64-linux-gnu-
